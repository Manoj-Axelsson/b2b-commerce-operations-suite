...
export const ProductGrid = ({ products, categoryName, isEmpty }: ProductGridProps) => {
        ...
        return (
            <div className="w-full py-20 flex flex-col items-center justify-center text-center animate-in fade-in duration-700">
                <div className="w-20 h-20 bg-brand-cream rounded-full flex items-center justify-center mb-6 border border-brand-gold/10">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-brand-primary/30">
                ...
                <p className="text-brand-primary/60 max-w-xs">
                    {categoryName
    ...
    return (
        <div className="w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            {categoryName && (
                <div className="flex items-end gap-4 border-b border-brand-gold/20 pb-4">
                    <h2 className="text-brand-primary text-3xl md:text-4xl font-bold font-serif leading-none capitalize">
                        {categoryName}
                    </h2>
                    <span className="text-brand-gold font-bold text-sm uppercase tracking-widest leading-none pb-1">
