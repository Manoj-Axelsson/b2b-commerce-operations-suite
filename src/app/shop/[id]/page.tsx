    ...
    return (
        <main className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
            <div className="mb-8">
                <Link
                    href="/shop"
                    className="group flex items-center text-sm font-bold uppercase tracking-widest text-brand-primary/60 transition-colors hover:text-brand-gold"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="mr-2 h-4 w-4 transition-transform group-hover:-translate-x-1">
